  ...
  return (
    <>
      <motion.div
        ...
        className={`bg-white rounded-lg p-4 text-center cursor-pointer shadow-md hover:shadow-lg transition-all border-2 relative overflow-hidden ${
      ...
      >
        ...
        <h3 className="text-xs md:text-sm font-semibold text-gray-800 truncate px-1">
          {monster.name}
        </h3>
